  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col lg:flex-row min-h-0">
        {/* Mobile Header */}
        <div className="lg:hidden bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-3 flex items-center justify-between z-50">
          <h1 className="text-lg font-bold">
            {selectedSubtask?.name || 'Learning Tasks'}
          </h1>
          <button
